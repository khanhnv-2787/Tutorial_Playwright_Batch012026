...
- Save to: `/pages/{site-name}/{page-name-kebab-case}/index.ts`
- Import site-specific configurations
- Use site-aware navigation methods
- Generate corresponding test file in `/tests/{site-name}/{page-name-kebab-case}.spec.ts`

### Single-Site Multi-Role Project Output

- Save to: `/pages/{role}/{page-name-kebab-case}/index.ts` (role-specific pages)
- Save to: `/pages/common/{page-name-kebab-case}/index.ts` (shared pages)
- Use role-aware access validation
- Generate corresponding test file in `/tests/{role}/{page-name-kebab-case}.spec.ts`

### Generated Files Include:

- Complete TypeScript page class file (kebab-case name)
...
- Selector files in `/locales/ja/selectors/{feature-name-kebab-case}.json` for reuse in tests
...
- Extract all selectors to `/locales/ja/selectors/{feature-name}.json` using kebab-case.
